...
<div class="login-box">
    ...
    <a style = "position:relative; left:-610px; top:-50px;" class="btn btn-primary" href="{{ route('register') }}">
    Registrar Usurario
    </a>
    <a style = "position:relative; left:-450px; top: -35px;" class="btn btn-primary" >
    Solicitudes de
       Prestamos
    </a>
